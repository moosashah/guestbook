 ...
 */
export async function isAuthorizedForEvent(user: AuthenticatedUser, eventId: string): Promise<boolean> {
    try {
 ...
 */
export async function authenticateAndAuthorizeForEvent(req: NextRequest, eventId: string) {
