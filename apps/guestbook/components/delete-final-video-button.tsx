...
export function DeleteFinalVideoButton({ eventId, hasFinalVideo, onVideoDeleted }: DeleteFinalVideoButtonProps) {
        ...
        <AlertDialog>
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        Are you sure you want to delete the compiled final video? This action cannot be undone.
                        You will need to recompile the video if you want to generate it again.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
