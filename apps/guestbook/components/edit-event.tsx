...
export function EditEventForm({ event, bannerImageUrl, welcomeMessageUrl }: EditEventFormProps) {
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                                ...
                                {bannerPreview ? (
                                    <div className="space-y-2">
                                        {bannerImageUrl && !bannerImage && (
                                            <p className="text-sm text-muted-foreground">Current banner image:</p>
                                        )}
                                        {bannerImage && (
                                            <p className="text-sm text-muted-foreground">New banner image preview:</p>
                                        )}
                                    ...
                                    <div>
                                        <p className="text-sm text-muted-foreground mb-2">
                                            {!bannerImageUrl ? "No banner image currently set." : "Upload a new banner image for your event."}
                                        </p>
                ...
                <Card>
                    <CardContent className="pt-6">
                        ...
                        {welcomeMessageUrl && (
                            <div className="mb-4">
                                <p className="text-sm text-muted-foreground mb-2">Current welcome message:</p>
                        ...
                        <p className="text-sm text-muted-foreground mb-4">
                            {welcomeMessageUrl ? "Record a new welcome message for your guests. This will replace the existing welcome message." : "Upload a welcome message for your guests."}
                        </p>
