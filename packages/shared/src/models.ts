...
export const createEventEntity = (client: DynamoDB.DocumentClient) =>
  new Entity(
    {
      model: {
        entity: 'Event',
      ...
      attributes: {
        ...
        package: {
          type: ['basic', 'deluxe', 'premium'] as const,
          required: true,
        },
        payment_status: {
          type: ['pending', 'success'] as const,
          required: true,
        },
      },
      indexes: {
...
export const createMessageEntity = (client: DynamoDB.DocumentClient) =>
  new Entity(
    {
      model: {
        entity: 'Message',
