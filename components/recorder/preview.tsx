...
const VideoPreview = ({ videoRef, recordedMedia }: { videoRef: React.RefObject<HTMLVideoElement | null>, recordedMedia: string | undefined }) => {
...
const AudioPreview = ({ audioRef, recordedMedia }: { audioRef: React.RefObject<HTMLAudioElement | null>, recordedMedia: string | undefined }) => (
  <div className="mb-4">
